...
void printToken(TokenType token, string s)
{
    switch (token)
    {
        ...
        case UNTIL:
        case READ:
        case WRITE: cout << "RESERVED WORD: " << s << endl; break;
        ...
        case NUM: cout << "NUM, val = " << tokenString << endl; break;
        case ID: cout << "ID, name = " << tokenString << endl; break;
        case ERROR: cout << "ERROR: " << tokenString << endl; break;
        default: cout << "UNKNOWN TOKEN" << endl; break;
    }
}
